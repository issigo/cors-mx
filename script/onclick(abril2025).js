...
var p2pConfi= str.search("var player;");
      ...
      var m3u8=data.substr(playbackURL+23, p2pConfi-playbackURL-26);//15+8
...
//$('#b'+(idbutton+1)).attr('onClick', "changeChannel(this,'https://deportesmx.vercel.app/online/player.html?get="+m3u8+"','"+nombre+"');");//}
    $('#b'+(idbutton+1)).attr('onClick', "changeChannel(this,'https://deportesmx.vercel.app/online/player.html?get=https://"+m3u8+"','"+nombre+"');");
